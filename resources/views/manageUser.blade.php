...
@section('content')
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 justify-content-between">
                            ...
                            <div class="d-flex">
                                <form action="{{route('search')}}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto my-2 my-md-0 mw-100 ">
                                    @csrf
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-capitalize"> @if(!empty($user->getRoleNames()))
