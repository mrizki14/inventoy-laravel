...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <form action="{{ route('update.kategori', $category->id)}}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-between mx-2">
                    <a class="btn btn-info" href="categories"> Kembali </a>
                    <button class="btn btn-success" href="kategori_add" type="submit">Update</button>
                </div>
            </form>
        </div>
    </div>
